...
```{r}
ui <- fluidPage(titlePanel("Log10.hra Homerange by Taxon"), #adds title to the app
                radioButtons("x", "Select Taxon", choices=c("birds", "lake fishes", "lizards", "mammals", "river fishes", "marine fishes", "snakes", "tortoises", "turtles"), selected="trophic.guild"),
                plotOutput("plot", width="600px", height="500px")
)
...
ui <- fluidPage(
    ...
    plotOutput("plot", width="500px", height="400px") #providing the size of the visual
)
...
ui <- dashboardPage(
  ...
  dashboardBody(
    fluidRow(
      box(selectInput("x", "Select X Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm"),
