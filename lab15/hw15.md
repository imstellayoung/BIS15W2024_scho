...
Two benefits of AI are the in efficiency like for error detection and correction. Another benefit is code optimization such as enhancing speed. Two drawbacks are the overreliance on AI and that AI still has difficulty with ambiguity. 


10. Do you think you will use AI for coding in the future? Why or why not?
I think I wil as a reference, but not as a clutch. If I am stuck on something I would reference it to AI, but I don't want the AI to write the code for me from the get go. 
