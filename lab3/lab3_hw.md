...
```r
small_body <- filter(sleep,bodywt<=19)
small_body
```
...
```r
big_body <- filter(sleep,bodywt>=200)
big_body
```
...
```r
small_bodywt <- c(small_body$bodywt)
small_bodywt
```

```
##  [1]  0.480  1.350  0.019  3.850  0.045 14.000 14.800  0.728  4.750  0.420
## [11]  0.060  1.000  0.005  3.500  2.950  1.700  0.023  0.770 10.000  0.071
## [21]  3.300  0.200  2.625  1.670  0.370  6.800  0.053  0.120  0.035  0.022
## [31]  0.010  0.266  1.400  0.210  0.028  2.500  0.550  1.100  0.021  1.620
## [41]  1.100  3.600  0.320  0.044  0.743  0.075  0.148  0.122  0.920  0.101
## [51]  0.205  0.048  4.500  0.112  0.900  0.104  2.000  3.380  4.230
```
...
```r
mean(small_body$bodywt, na.rm=TRUE)
```
...
```r
mean(big_body$bodywt, nar.rm=TRUE)
```
